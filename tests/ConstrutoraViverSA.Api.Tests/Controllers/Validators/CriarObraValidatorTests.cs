...
public class CriarObraValidatorTests
{
    ...
    public void CriarObraValidator_DadoUmPrazoConclusaoInvalido_DeveRetornarErros([StringSyntax(StringSyntaxAttribute.DateTimeFormat)]string prazoConclusaoString)
    {
