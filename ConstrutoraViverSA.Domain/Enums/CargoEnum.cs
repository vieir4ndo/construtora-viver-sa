...
namespace ConstrutoraViverSA.Domain.Enums
{
    public enum CargoEnum
    {
		...
		[Display(Name = "Menor Aprendiz")]
		MenorAprendiz = 18,

		[Display(Name = "Estágiario")]
		Estágiario = 19,

		[Display(Name = "Engenheiro Cívil")]
		EngenheiroCivil = 20,
		...
		[Display(Name = "Diretor de Fábrica")]
		DiretorFabrica = 23,

		[Display(Name = "Pedreiro")]
		Pedreiro = 24,

		[Display(Name = "Pedreiro de Acabamento")]
		PedreiroAcabamento = 25,

		[Display(Name = "Carpinteiro")]
		Carpinteiro = 26,

		[Display(Name = "Mestre de Obras")]
		MestreObras = 27,

		[Display(Name = "Servente")]
		Servente = 28,
